		...
		<view class="base-scroll-list-rows-wrapper"
			...
			>
				...
				<view style="display: flex;flex-direction: row;width: 100%;">
					<view class="base-text" style="width: 15%;">{{item.OrderNum}}</view>
					<view class="base-text"style="width: 20%;">{{item.PlanOutDate}}</view>
					<view class="base-text"style="width: 20%">{{item.Machine}}</view>
					<view class="base-text"style="width: 15%;">{{item.Qty}}</view>
					<view class="base-text"style="width: 20%">{{item.MachineNum}}</view>
				
					<view class="base-text" style="width: 10%">{{item.CompleteState}}</view>
					<!-- <view class="base-text" style="width: 10%;">{{item.Desc}}</view> -->
				</view>
				</view>
			</view>
		</view>	
